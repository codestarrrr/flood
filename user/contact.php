...
while($row = mysql_fetch_array($result)){
			...
			echo	'<td>'.$row['dept'].'</td>';
			echo	'<td>&nbsp;</td>';
			echo		'<td><a href="tel:'.$row['number'].'" style="color:lightblue">'.$row['number'].'</a></td>';
			echo	'</tr>';
			echo	'<tr>';
			echo		'<td>&nbsp;</td>';
			echo		'<td>&nbsp;</td>';
			...
			?>
				...
				<!--	<td>MDRRMO:</td>-->
				<!--	<td>&nbsp;</td>-->
				<!--	<td><a href="tel:09558805252" style="color:lightblue">0955-880-5252</a></td>-->
				<!--</tr>-->
				<!--<tr>-->
				<!--	<td>&nbsp;</td>-->
				<!--	<td>&nbsp;</td>-->
			...
			<!--		<td>PNP:</td>-->
			<!--		<td>&nbsp;</td>-->
			<!--		<td><a href="tel:09167194906" style="color:lightblue">0916-719-4906</a></td>-->
			<!--	</tr>-->
			<!--	<tr>-->
			<!--		<td>&nbsp;</td>-->
			<!--		<td>&nbsp;</td>-->
			...
			<!--		<td>BFP:</td>-->
			<!--		<td>&nbsp;</td>-->
			<!--		<td><a href="tel:09167199404" style="color:lightblue">0916-719-9404</a></td>-->
			<!--	</tr>-->
			<!--	<tr>-->
			<!--		<td>&nbsp;</td>-->
			<!--		<td>&nbsp;</td>-->
			...
			<!--		<td>LOBO Hospital:</td>-->
			<!--		<td>&nbsp;</td>-->
			<!--		<td><a href="tel:09173019391" style="color:lightblue">0917-301-9391</a></td>-->
			<!--	</tr>-->
			<!--	<tr>-->
			<!--		<td>&nbsp;</td>-->
			<!--		<td>&nbsp;</td>-->
			...
			<!--		<td>Batelec Lobo:</td>-->
			<!--		<td>&nbsp;</td>-->
			<!--		<td><a href="tel:09178864465" style="color:lightblue">0917-886-4465</a></td>-->
			<!--	</tr>-->
			<!--	<tr>-->
			<!--		<td>&nbsp;</td>-->
			<!--		<td>&nbsp;</td>-->
			...
			<!--		<td>&nbsp;</td>-->
			<!--		<td><a href="tel:09175301641" style="color:lightblue">0917-530-1641</a></td>-->
			<!--	</tr>-->
			<!--	<tr>-->
			<!--		<td>&nbsp;</td>-->
			<!--		<td>&nbsp;</td>-->
