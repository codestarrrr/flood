	...
	<script>
		...
		$(function() {
			...
			<div class="header"  style="background-color:#e6e600;color:#000;">
			 ...
			 <center>
			 <table width="90%" border="0" style="font-size:20px">
				<tr>
					<td width="45%" valign="top"><center><img src="images/level.png" width="80%" onclick="window.location='flood.php'"><br><h3 style="color:#FFF">Flood Level</td>
					<td>&nbsp;</td>
					<td width="45%" valign="top"><center><img src="images/evacuation.png" width="80%" onclick="window.location='evacuation.php'"><br><h3 style="color:#FFF">Evacuation</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td width="45%" valign="top"><center><img src="images/contact.png" width="80%" onclick="window.location='contact.php'"><br><h3 style="color:#FFF">Contact</td>
					<td>&nbsp;</td>
					<td width="45%" valign="top"><center><img src="images/about.png" width="80%" onclick="window.location='about.php'"><br><h3 style="color:#FFF">About</td>
				</tr>
			 </table>
