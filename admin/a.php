...
<?php 
					...
					<tr style="height:30px">
						...
						<td></td>
						<td valign="bottom" style="color:#FFF;font-size:18px">sa</td>
					</tr>
					...
					<tr style="height:30px">
						<td style="border:1px solid #FFF;background-color:green" valign="middle"><center style="color:#000"></center> -  Low</td>
						<td></td>
						<td valign="bottom" style="color:#FFF;font-size:18px"> -  Low</td>
					</tr>
					</tr>
