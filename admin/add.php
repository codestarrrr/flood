...
padding: 2px; 
			...
			<div class="header"  style="background-color:#e6e600;color:#000;">
			 ...
			 <div class="content" style="font-size:20px">
			  ...
			  <h2>Add Evacuation Centers</h2>
			  
			 <center>
			 <form action="addexec.php" method="POST">   
				<input type="text" name="name" required placeholder="Evacuation Center">
<br>
				<input type="text" name="classroom" required placeholder="Number of Classroom">
<br>
				<input type="text" name="toilet" required placeholder="Status of Toilet">
<br>
				<input type="text" name="water" required placeholder="Status of Water">
<br>
				<input type="text" name="lightning" required placeholder="Status of Lightning">
<br>
				<input type="text" name="contact" required placeholder="Contact Number">
<br>
				<input type="text" name="person" required placeholder="Contact Person">
<br>
<input type="submit" name="submit" value="Add Evacuation Center" class="myButton">
			 </form>
